      ...
      <div className="bg-white">
        ...
        <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl font-bold text-oasis-green-800">Our Products</h1>
          ...
          <div className="mt-12 grid gap-8 md:grid-cols-2">
            <div className="bg-[#F3F8E4] p-8 rounded-lg hover:shadow-lg transition-shadow duration-300">
              <h3 className="text-2xl font-semibold text-oasis-green-800 mb-4">Enterprise Browser</h3>
            ...
            <div className="bg-[#F3F8E4] p-8 rounded-lg hover:shadow-lg transition-shadow duration-300">
              <h3 className="text-2xl font-semibold text-oasis-green-800 mb-4">Web Application</h3>
              <p className="text-oasis-green-800 mb-6">
          ...
          {/* Resources Section */}
          <div className="mt-16">
            <h2 className="text-2xl font-bold text-oasis-green-800 text-center mb-8">Resources</h2>
            <div className="grid gap-8 md:grid-cols-3">
              ...
              <div className="bg-gradient-to-br from-desert-yellow-100/20 to-oasis-blue-300/10 rounded-xl p-8">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-2xl font-bold text-oasis-green-800">Support</h3>
                </div>
                <p className="text-oasis-green-800 mb-6">
