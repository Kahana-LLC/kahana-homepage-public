...
export default function Retail({ retailBlogs }) {
  ...
  return (
    <>
      ...
      <section className="bg-gradient-to-b from-oasis-blue-100/20 via-oasis-blue-300/10 to-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-base font-semibold leading-7 text-brand-link mb-3">Retail & e-commerce</h2>
      ...
      <SharedCTA
        title="Store and digital collaboration without operational drag"
        description="Put governance back in the browser for retail SaaS, with secure access from any device, policy enforcement, and visibility your security and IT teams can stand behind."
