...
const CANONICAL = 'https://kahana.io/features/oasis-enterprise-external-access';

export async function getStaticProps() {
  return getFeatureRelatedDocsProps('oasis-enterprise-external-access');
}

export default function OasisEnterpriseExternalAccessPage({ relatedDocs = [] }) {
  const schema = {
  ...
  return (
    ...
    >
      ...
      <EnterpriseFeatureExplainerDiagram variant="external" />
      <EnterpriseFeatureVisual slug="oasis-enterprise-external-access" />
    </FeatureDeepDiveShell>
  );
}
