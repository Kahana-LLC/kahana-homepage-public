        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <article className="prose prose-lg max-w-none">
            ...
            <section id="accounts-registration" className="mb-16 scroll-mt-8">
              ...
              <p className="text-gray-700 leading-relaxed mb-6">
                You acknowledge and agree that your use of third-party Login services is also governed by the terms of service and privacy policies of the applicable third-party provider. Kahana does not make any representations or warranties regarding the security or privacy practices of any third-party identity providers. If you suspect that your account has been compromised or is no longer secure, you must immediately notify us by <Link href="/contact" className="text-[#4A6200] hover:underline font-semibold">contacting us through our contact form</Link>.
              </p>
            </section>
            ...
            <section id="user-content" className="mb-16 scroll-mt-8">
              ...
              <h3 className="text-2xl font-bold text-[#313A00] mb-4 mt-8">8.2. License Grant to Kahana</h3>
              <p className="text-gray-700 leading-relaxed mb-6">
              ...
              <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4 ml-4">
                <li>(a) you are the creator and owner of the User Content, or you possess the necessary licenses, rights, consents, and permissions to authorize Kahana and Service users to use and distribute your User Content as required to exercise the licenses you grant in this Section, consistent with how Kahana, the Service, and these Terms contemplate such use;</li>
            ...
            <section id="prohibited-conduct" className="mb-16 scroll-mt-8">
              ...
              <ul className="list-disc list-inside text-gray-700 space-y-2 mb-6 ml-4">
                ...
                <li>10.7. access, search, or otherwise utilize any portion of the Service using any engine, software, tool, agent, device, or mechanism (such as spiders, robots, crawlers, and data mining tools) other than the software or search agents that Kahana provides;</li>
            ...
            <section id="miscellaneous" className="mb-16 scroll-mt-8">
              ...
              <p className="text-gray-700 leading-relaxed mb-6">
                The Service is provided by Kahana Group Inc., with offices located at 1550 North Lakeshore Drive, Apt 19E, Chicago, Illinois, 60610. You may reach us by sending correspondence to that address, by <Link href="/contact" className="text-[#4A6200] hover:underline font-semibold">contacting us through our contact form</Link>, or by emailing us at info@kahana.co.
              </p>
