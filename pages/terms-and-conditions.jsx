        ...
        <div className="bg-gradient-to-b from-[#EDE6D2] to-white py-16 sm:py-24">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-8">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-[#3B2F1A] mb-6">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <article className="prose prose-lg max-w-none">
            ...
            <section className="mb-16 scroll-mt-8">
              <h2 className="text-3xl font-bold text-[#3B2F1A] mb-6">Kahana Group Inc. Terms of Service</h2>
            ...
            <section id="important-notice" className="mb-16 scroll-mt-8">
              <div className="mb-4">
                <span className="inline-block px-3 py-1 text-xs font-semibold text-oasis-green-800 bg-[#EDE6D2] rounded-md mb-2">
                  Important Notice
                </span>
              </div>
              <h2 className="text-3xl font-bold text-[#3B2F1A] mb-6">Please read carefully</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <section id="service-overview" className="mb-16 scroll-mt-8">
              ...
              <h2 className="text-3xl font-bold text-[#3B2F1A] mb-6">1. Service Overview</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <section id="eligibility" className="mb-16 scroll-mt-8">
              ...
              <h2 className="text-3xl font-bold text-[#3B2F1A] mb-6">2. Eligibility</h2>
              <p className="text-gray-700 leading-relaxed mb-6">
            ...
            <section id="accounts-registration" className="mb-16 scroll-mt-8">
              ...
              <h2 className="text-3xl font-bold text-[#3B2F1A] mb-6">3. Accounts and Registration</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
              ...
              <p className="text-gray-700 leading-relaxed mb-6">
                You acknowledge and agree that your use of third-party Login services is also governed by the terms of service and privacy policies of the applicable third-party provider. Kahana Group Inc. does not make any representations or warranties regarding the security or privacy practices of any third-party identity providers. If you suspect that your account has been compromised or is no longer secure, you must immediately notify us by <Link href="https://kahana.io/contact" className="text-[#8A6622] no-underline hover:no-underline font-semibold">contacting us through our contact form</Link>.
              </p>
            </section>
            ...
            <section id="payment-terms" className="mb-16 scroll-mt-8">
              ...
              <h2 className="text-3xl font-bold text-[#3B2F1A] mb-6">4. Payment Terms</h2>
              
              <h3 className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8">4.1. Payment Terms Generally</h3>
              <p className="text-gray-700 leading-relaxed mb-6">
              ...
              <h3 className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8">4.2. Pricing</h3>
              <p className="text-gray-700 leading-relaxed mb-6">
              ...
              <h3 className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8">4.3. Payment Authorization</h3>
              <p className="text-gray-700 leading-relaxed mb-6">
              ...
              <h3 className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8">4.4. Subscription Services</h3>
              <p className="text-gray-700 leading-relaxed mb-4">
              ...
              <h3 className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8">4.5. Payment Processors</h3>
              <p className="text-gray-700 leading-relaxed mb-4">
              ...
              <h3 className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8">4.6. Account Delinquency</h3>
              <p className="text-gray-700 leading-relaxed mb-6">
              ...
              <h3 id="no-refunds" className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8 scroll-mt-8">4.7. No Refunds</h3>
              <p className="text-gray-700 leading-relaxed mb-4">
              ...
              <h3 id="purchased-hub-access" className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8 scroll-mt-8">4.8. Purchased Hub Access and Creator Content</h3>
              <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <section id="licenses" className="mb-16 scroll-mt-8">
              ...
              <h2 className="text-3xl font-bold text-[#3B2F1A] mb-6">5. Licenses</h2>
              
              <h3 className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8">5.1. License Grant</h3>
              <p className="text-gray-700 leading-relaxed mb-6">
              ...
              <h3 className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8">5.2. Restrictions on License</h3>
              <p className="text-gray-700 leading-relaxed mb-6">
              ...
              <h3 className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8">5.3. Feedback</h3>
              <p className="text-gray-700 leading-relaxed mb-6">
            ...
            <section id="ownership" className="mb-16 scroll-mt-8">
              ...
              <h2 className="text-3xl font-bold text-[#3B2F1A] mb-6">6. Ownership and Proprietary Rights</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <section id="third-party-terms" className="mb-16 scroll-mt-8">
              ...
              <h2 className="text-3xl font-bold text-[#3B2F1A] mb-6">7. Third-Party Terms</h2>
              
              <h3 className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8">7.1. Third-Party Services and Website Links</h3>
              <p className="text-gray-700 leading-relaxed mb-6">
              ...
              <h3 className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8">7.2. Third-Party Software</h3>
              <p className="text-gray-700 leading-relaxed mb-6">
            ...
            <section id="user-content" className="mb-16 scroll-mt-8">
              ...
              <h2 className="text-3xl font-bold text-[#3B2F1A] mb-6">8. User Content</h2>
              
              <h3 className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8">8.1. User Content Overview</h3>
              <p className="text-gray-700 leading-relaxed mb-6">
              ...
              <h3 className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8">8.2. License Grant to Kahana Group Inc.</h3>
              <p className="text-gray-700 leading-relaxed mb-6">
              ...
              <h3 className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8">8.3. Rights to Posted Content; Representations and Warranties</h3>
              <p className="text-gray-700 leading-relaxed mb-4">
              ...
              <h3 className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8">8.4. Disclaimer Regarding User Content</h3>
              <p className="text-gray-700 leading-relaxed mb-6">
              ...
              <h3 className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8">8.5. Content Monitoring</h3>
              <p className="text-gray-700 leading-relaxed mb-6">
            ...
            <section id="communications" className="mb-16 scroll-mt-8">
              ...
              <h2 className="text-3xl font-bold text-[#3B2F1A] mb-6">9. Communications</h2>
              <p className="text-gray-700 leading-relaxed mb-6">
                ...
                <Link href="/privacy-policy" className="text-[#8A6622] no-underline hover:no-underline font-semibold">Privacy Policy</Link>{' '}
                for how we use your email address.
              </p>

              <h3 id="communications-optional" className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8 scroll-mt-8">9.1. Optional product and onboarding emails</h3>
              <p className="text-gray-700 leading-relaxed mb-4">
              ...
              <p className="text-gray-700 leading-relaxed mb-6">
                You may unsubscribe from these optional emails at any time by following the unsubscribe link in any such email or by <Link href="https://kahana.io/contact" className="text-[#8A6622] no-underline hover:no-underline font-semibold">contacting us through our contact form</Link>.
              </p>

              <h3 id="communications-required" className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8 scroll-mt-8">9.2. Required transactional and account emails</h3>
              <p className="text-gray-700 leading-relaxed mb-4">
              ...
              <h3 id="communications-electronic" className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8 scroll-mt-8">9.3. Electronic delivery</h3>
              <p className="text-gray-700 leading-relaxed mb-6">
            ...
            <section id="prohibited-conduct" className="mb-16 scroll-mt-8">
              ...
              <h2 className="text-3xl font-bold text-[#3B2F1A] mb-6">10. Prohibited Conduct</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <section id="modification-terms" className="mb-16 scroll-mt-8">
              ...
              <h2 className="text-3xl font-bold text-[#3B2F1A] mb-6">11. Modification of Terms</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <section id="trial-period" className="mb-16 scroll-mt-8">
              ...
              <h2 className="text-3xl font-bold text-[#3B2F1A] mb-6">12. Trial Period</h2>
              
              <h3 className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8">12.1. Terms of Trial</h3>
              <p className="text-gray-700 leading-relaxed mb-6">
              ...
              <h3 className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8">12.2. Disclaimer for Trial</h3>
              <p className="text-gray-700 leading-relaxed mb-6">
            ...
            <section id="term-termination" className="mb-16 scroll-mt-8">
              ...
              <h2 className="text-3xl font-bold text-[#3B2F1A] mb-6">13. Term, Termination, and Service Modifications</h2>
              
              <h3 className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8">13.1. Term of Agreement</h3>
              <p className="text-gray-700 leading-relaxed mb-6">
              ...
              <h3 className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8">13.2. Termination Rights</h3>
              <p className="text-gray-700 leading-relaxed mb-6">
                ...
                <a href="https://kahana.io/support" className="text-[#8A6622] no-underline hover:no-underline font-semibold">Support</a>
                , through available account settings, or by reaching out through{' '}
                <Link href="https://kahana.io/contact" className="text-[#8A6622] no-underline hover:no-underline font-semibold">our contact form</Link>.
              </p>

              <h3 className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8">13.3. Consequences of Termination</h3>
              <p className="text-gray-700 leading-relaxed mb-6">
              ...
              <h3 className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8">13.4. Service Modifications</h3>
              <p className="text-gray-700 leading-relaxed mb-6">
              ...
              <h3 id="dormant-accounts" className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8 scroll-mt-8">13.5. Dormant accounts</h3>
              <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <section id="indemnity" className="mb-16 scroll-mt-8">
              ...
              <h2 className="text-3xl font-bold text-[#3B2F1A] mb-6">14. Indemnity</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <section id="disclaimers" className="mb-16 scroll-mt-8">
              ...
              <h2 className="text-3xl font-bold text-[#3B2F1A] mb-6">15. Disclaimers and No Warranties</h2>
              
              <h3 className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8">15.1. Service Provided As-Is</h3>
              <p className="text-gray-700 leading-relaxed mb-4">
              ...
              <h3 className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8">15.2. No Warranties from Communications</h3>
              <p className="text-gray-700 leading-relaxed mb-6">
              ...
              <h3 className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8">15.3. Maximum Extent of Limitations</h3>
              <p className="text-gray-700 leading-relaxed mb-6">
            ...
            <section id="limitation-liability" className="mb-16 scroll-mt-8">
              ...
              <h2 className="text-3xl font-bold text-[#3B2F1A] mb-6">16. Limitation of Liability</h2>
              
              <h3 className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8">16.1. Exclusion of Indirect Damages</h3>
              <p className="text-gray-700 leading-relaxed mb-6">
              ...
              <h3 className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8">16.2. Cap on Aggregate Liability</h3>
              <p className="text-gray-700 leading-relaxed mb-6">
              ...
              <h3 className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8">16.3. Allocation of Risk</h3>
              <p className="text-gray-700 leading-relaxed mb-6">
            ...
            <section id="dispute-resolution" className="mb-16 scroll-mt-8">
              ...
              <h2 className="text-3xl font-bold text-[#3B2F1A] mb-6">17. Dispute Resolution and Arbitration</h2>
              
              <h3 className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8">17.1. General Provisions</h3>
              <p className="text-gray-700 leading-relaxed mb-4">
              ...
              <h3 className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8">17.2. Exceptions to Arbitration</h3>
              <p className="text-gray-700 leading-relaxed mb-6">
              ...
              <h3 className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8">17.3. Right to Opt-Out</h3>
              <p className="text-gray-700 leading-relaxed mb-6">
              ...
              <h3 className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8">17.4. Selection of Arbitrator</h3>
              <p className="text-gray-700 leading-relaxed mb-6">
              ...
              <h3 className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8">17.5. Initiating Arbitration</h3>
              <p className="text-gray-700 leading-relaxed mb-6">
              ...
              <h3 className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8">17.6. Conduct of Arbitration</h3>
              <p className="text-gray-700 leading-relaxed mb-6">
              ...
              <h3 className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8">17.7. Available Relief in Arbitration</h3>
              <p className="text-gray-700 leading-relaxed mb-6">
              ...
              <h3 className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8">17.8. Prohibition of Class Actions</h3>
              <p className="text-gray-700 leading-relaxed mb-6">
              ...
              <h3 className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8">17.9. Changes to Arbitration Provision</h3>
              <p className="text-gray-700 leading-relaxed mb-6">
              ...
              <h3 className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8">17.10. Enforceability of Arbitration</h3>
              <p className="text-gray-700 leading-relaxed mb-6">
            ...
            <section id="miscellaneous" className="mb-16 scroll-mt-8">
              ...
              <h2 className="text-3xl font-bold text-[#3B2F1A] mb-6">18. Miscellaneous</h2>
              
              <h3 className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8">18.1. General Provisions</h3>
              <p className="text-gray-700 leading-relaxed mb-6">
              ...
              <h3 className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8">18.2. Applicable Law and Jurisdiction</h3>
              <p className="text-gray-700 leading-relaxed mb-6">
              ...
              <p className="text-gray-700 leading-relaxed mb-6">
                ...
                {' '}and{' '}
                <Link href="/community-guidelines" className="text-[#8A6622] no-underline hover:no-underline font-semibold">
                  Community Guidelines
                </Link>
                , as well as related in-app legal pages under app.kahana.io/legal.
              </p>

              <h3 className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8">18.5. Electronic Communication Consent</h3>
              <p className="text-gray-700 leading-relaxed mb-6">
              ...
              <h3 className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8">18.6. How to Contact Us</h3>
              <p className="text-gray-700 leading-relaxed mb-6">
                The Service is provided by Kahana Group Inc., with offices located at 1550 North Lakeshore Drive, Apt 19E, Chicago, Illinois, 60610. You may reach us by sending correspondence to that address or by <Link href="https://kahana.io/contact" className="text-[#8A6622] no-underline hover:no-underline font-semibold">contacting us through our contact form</Link>.
              </p>

              <h3 className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8">18.7. California Residents' Rights</h3>
              <p className="text-gray-700 leading-relaxed mb-6">
              ...
              <h3 className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8">18.8. Support Not Guaranteed</h3>
              <p className="text-gray-700 leading-relaxed mb-6">
