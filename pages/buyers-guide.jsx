            ...
            <div className="lg:grid lg:grid-cols-12 lg:gap-16">
              ...
              <div className="lg:col-span-7">
                <div className="text-center lg:text-left mb-12">
                  <h2 className="text-base font-semibold leading-7 text-brand-link mb-3">Enterprise Browser Guide</h2>
                    ...
                    <div className="bg-white rounded-xl shadow-xl border border-oasis-blue-200/30 p-8">
                      ...
                      <div className="grid grid-cols-1 gap-2">
                        {sections.map(section => (
                          ...
                          >
                            <div className="flex-shrink-0 w-8 h-8 bg-brand-link rounded-full flex items-center justify-center mr-4">
