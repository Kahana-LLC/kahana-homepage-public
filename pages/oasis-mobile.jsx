...
export default function OasisMobile() {
  ...
  const renderForm = () => (
    <div className="w-full">
      ...
      <iframe
        src="https://tally.so/r/mRA59K"
        width="100%"
        height="400"
        frameBorder="0"
        marginHeight="0"
        marginWidth="0"
        title="Oasis Mobile Waitlist"
        style={{ 
          border: 0,
          borderRadius: 0,
              ...
              <div className="lg:col-span-7">
                <div className="text-center lg:text-left mb-12">
                  ...
                  <p className="mt-6 text-xl text-gray-600">
                    Meet Oasis Mobile, the agentic browser that elevates how you explore and organize the web on your mobile device. Instead of hunting through endless tabs, scrolling through browser history, or juggling multiple windows, simply tell Oasis what you need. 
                  </p>
