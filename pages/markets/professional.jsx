...
const securityFeatures = [
  {
    ...
    description: 'Safeguard sensitive client information and documents.',
    details: [
      'Data encryption',
      'Access controls',
      'Audit logging',
  ...
  },
  {
    ...
    description: 'Control access for staff and clients.',
    details: [
      'Role-based access',
  ...
  },
  {
    ...
    description: 'Protect contracts, reports, and sensitive files.',
    details: [
      'Document encryption',
      'Version control',
      'Watermarking',
...
const industryBenefits = [
  ...
  },
  {
    ...
    description: 'Improved client experience and retention.',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: 'Built-in compliance for professional standards.',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <>
      ...
      <section className="bg-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-gray-600 text-center mb-8 max-w-3xl mx-auto">
            Discover how our solutions deliver enterprise-grade security for professional services. Our security-first approach helps organizations protect client data and maintain compliance.
          </p>
      ...
      <section className="bg-gray-50 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-gray-600 text-center mb-8 max-w-3xl mx-auto">
            Experience a new way of professional services operations with smart solutions and enhanced productivity features. Learn how our platform is transforming professional services.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
