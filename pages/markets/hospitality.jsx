...
const industryBenefits = [
  {
    ...
    description: 'Enhance guest experience with streamlined services.',
    icon: '😊'
  },
  {
    ...
    description: 'Boost revenue through improved operations.',
    icon: '💰'
  },
  {
  ...
  },
  {
    ...
    description: 'Enhance staff productivity with better tools.',
    icon: '👥'
  }
];
      ...
      <section className="bg-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-gray-600 text-center mb-8 max-w-3xl mx-auto">
            Experience a new way of hospitality operations with smart solutions and enhanced productivity features. Learn how our platform is transforming hospitality.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-r from-[#66C2BE] to-[#8CB7D0] rounded-2xl p-12 text-center">
            ...
            <p className="text-white/90 mb-8 max-w-2xl mx-auto">
              Join leading hospitality organizations that trust Kahana for their digital transformation needs.
            </p>
            <div className="flex justify-center gap-4">
