      ...
      <section className="bg-gradient-to-b from-kahana-accent-sky/20 via-kahana-secondary-300/10 to-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-base font-semibold leading-7 text-kahana-primary mb-3">Energy & Utilities</h2>
            ...
            <div className="flex justify-center gap-4">
              ...
              <Link href="/sales">
                <button className="border border-kahana-primary text-kahana-primary px-8 py-3 rounded-md font-semibold hover:bg-kahana-primary/10 transition-colors">
                  Contact Sales
                </button>
              </Link>
            </div>
