...
const industryBenefits = [
  {
    ...
    source: {
      url: 'https://www2.deloitte.com/us/en/insights/industry/retail/digital-transformation.html',
      label: 'Deloitte, 2023'
    }
  },
  {
    ...
    source: {
      url: 'https://www.pwc.com/gx/en/industries/retail-consumer/publications/retail-client-experience.html',
      label: 'PwC, 2023'
    }
  },
  {
    ...
    source: {
      url: 'https://www.mckinsey.com/industries/retail/our-insights/digital-automation',
      label: 'McKinsey, 2023'
    }
  },
  {
    title: 'Compliance Ready',
    description: 'Built-in compliance for retail standards and regulatory requirements.',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    source: {
      url: 'https://www.gartner.com/en/documents/retail-compliance',
      label: 'Gartner, 2024'
    }
  }
];
...
const retailMetrics = [
  ...
  },
  {
    ...
    source: { url: 'https://www2.deloitte.com/us/en/insights/industry/retail/retail-compliance.html', label: 'Deloitte, 2023' }
  },
  {
    label: 'IT Support Tickets Reduced',
    value: '34%',
    insight: 'Fewer browser-related helpdesk tickets, freeing IT resources.',
    source: { url: 'https://www.mckinsey.com/industries/retail/our-insights/digital-automation', label: 'McKinsey, 2023' }
  },
  {
    label: 'Time to Onboard Staff',
    value: '2x faster',
    insight: 'Rapid, policy-driven onboarding for new employees.',
    source: { url: 'https://www2.deloitte.com/us/en/insights/industry/retail/digital-transformation.html', label: 'Deloitte, 2023' }
  },
  {
    label: 'Cost Savings',
    value: '18%',
    ...
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
              Transform your retail and e-commerce operations with secure, efficient solutions designed for modern retail challenges.
            </p>
      ...
      <section className="bg-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-gray-600 text-center mb-8 max-w-3xl mx-auto">
            Key metrics that matter to retail IT and security leaders evaluating enterprise browsers.
          </p>
      ...
      <section className="bg-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-gray-600 text-center mb-8 max-w-3xl mx-auto">
            Discover how our solutions deliver enterprise-grade security for retail operations. Our security-first approach helps organizations protect customer data and maintain compliance.
          </p>
      ...
      <section className="bg-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-gray-600 text-center mb-8 max-w-3xl mx-auto">
            See how retail organizations are transforming their operations and improving efficiency with our solutions.
          </p>
      ...
      <section className="bg-gradient-to-r from-[#66C2BE] to-[#8CB7D0] py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            Join leading retail organizations that trust Kahana for their digital transformation needs.
          </p>
          <div className="flex justify-center gap-4">
