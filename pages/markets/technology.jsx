...
const securityFeatures = [
  {
    title: 'Governance where engineering and SaaS work happens',
    description:
  ...
  {
    title: 'Secure access for contractors, outsourcers, and partners',
    description:
  ...
  {
    title: 'Unified browser policies across product, corporate, and remote teams',
    description:
...
const industryBenefits = [
  {
    title: 'Ship and support velocity',
    description:
    ...
    const technologyBlogs = blogIndex
      .filter(post =>
        normalizeBlogCategories(post.category).some(
          cat => cat.toLowerCase() === 'technology' || cat.toLowerCase() === 'security'
        )
      )
...
export default function Technology({ technologyBlogs }) {
  const techSchema = {
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    name: 'Technology & SaaS: Oasis managed enterprise browser | Kahana',
    description:
      'Oasis helps technology and SaaS organizations secure browser-centric work for engineering, product, and GTM teams, with session-level governance, unified policies, identity and DLP integration, and practical access for contractors without laptop shipping or VDI as the default.',
    mainEntity: {
      '@type': 'Organization',
      name: 'Kahana',
      description:
        'Kahana builds Oasis, a managed enterprise browser for secure SaaS access in technology and high-growth software organizations.',
    },
  };
  ...
  return (
    <>
      ...
      />
      <Head>
        <title>Technology & SaaS: Secure SaaS access with Oasis | Kahana</title>
        <meta
          name="description"
          content="Oasis is a managed enterprise browser for technology organizations: session-level governance, consistent browser policies across corporate and partner devices, and integration with identity and enterprise DLP, so contractors and integrators get productive without hardware logistics as the default gate."
        />
      </Head>
      <Script
      ...
      <section className="bg-gradient-to-b from-oasis-blue-100/20 via-oasis-blue-300/10 to-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-base font-semibold leading-7 text-brand-link mb-3">Technology & SaaS</h2>
            <h1 className="text-5xl font-bold text-oasis-green-800 mb-6">Secure browser governance for technology teams</h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 max-w-5xl mx-auto">
            {technologyMetrics.map((metric, idx) => {
              const isLastOdd =
                technologyMetrics.length % 2 === 1 && idx === technologyMetrics.length - 1;
              return (
                <div
                  key={idx}
                  className={[
      ...
      <FeaturedBlogSection posts={technologyBlogs} />

      <SharedCTA
        title="Ship fast without losing control of the browser"
        description="Put governance in the browser for engineering and SaaS workflows, with secure access from authorized devices, policy enforcement, and visibility your security and IT teams can stand behind."
