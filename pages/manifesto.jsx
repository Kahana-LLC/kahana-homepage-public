...
export default function Manifesto() {
  ...
  return (
    <>
          ...
          <div className="prose prose-lg">
            <section className="mb-16 fade-in-section">
              <h2 className="text-3xl font-bold text-gray-900 mb-6 flex items-center">
                <svg className="w-8 h-8 mr-3 text-brand-link" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="space-y-6">
                <div className="bg-gray-50 p-6 rounded-lg">
                  <h3 className="text-xl font-semibold text-gray-900 mb-2 flex items-center">
                    <svg className="w-6 h-6 mr-2 text-brand-link" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* CTA Section */}
      <div className="bg-gradient-to-br from-brand-link via-oasis-blue-300 to-oasis-blue-200 py-16">
