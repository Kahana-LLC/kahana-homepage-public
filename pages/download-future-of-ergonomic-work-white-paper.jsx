        ...
        {loadError && retryCount >= MAX_RETRIES && (
          <div className="absolute inset-0 flex flex-col items-center justify-center p-4 text-center">
            ...
            <button
              ...
              className="px-4 py-2 bg-brand-link text-white rounded-md hover:bg-brand-link-hover transition-colors"
            >
              Refresh Page
            </button>
          </div>
          ...
          <div className="lg:grid lg:grid-cols-12 lg:gap-16">
            ...
            <div className="lg:col-span-7">
              <div className="text-center lg:text-left mb-12">
                <h2 className="text-base font-semibold leading-7 text-brand-link mb-3">Free White Paper</h2>
              ...
              {/* Key Benefits */}
              <div className="mb-12">
                <h3 className="text-2xl font-semibold text-oasis-green-900 mb-6">What You'll Learn</h3>
                <div className="space-y-4">
                  <div className="flex items-start">
                    <div className="flex-shrink-0">
                      <div className="flex h-6 w-6 items-center justify-center rounded-full bg-brand-link text-white text-sm font-medium">
                        ✓
                      </div>
                    </div>
              ...
              <div className="mb-12 lg:mb-0">
                <h3 className="text-xl font-semibold text-oasis-green-900 mb-6">Explore More Resources</h3>
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                  {resourceLinks.map((link) => (
                    <Link
                      key={link.name}
                      href={link.href}
                      className="group flex flex-col p-6 bg-white rounded-xl border border-oasis-blue-200/30 shadow-sm hover:shadow-md transition-all duration-300"
                    >
                      <div className="flex-shrink-0 mb-4">
                        <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-gradient-to-br from-brand-link/10 via-oasis-blue-300/10 to-oasis-blue-100/10 group-hover:from-brand-link/20 group-hover:via-oasis-blue-300/20 group-hover:to-oasis-blue-100/20 transition-all duration-300">
                          <div className="text-brand-link">
                            {link.icon}
                          </div>
                        </div>
                      </div>
                      <h3 className="text-lg font-semibold text-oasis-green-900 group-hover:text-brand-link-hover transition-colors duration-300">
                        {link.name}
                      </h3>
