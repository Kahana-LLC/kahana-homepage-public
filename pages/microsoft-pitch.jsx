...
import {
  ...
  VisionBeyondSection
} from "../components/microsoft-pitch/index.jsx";
...
const MicrosoftPitch = () => {
  return (
    <div className="min-h-screen bg-white font-sf-pro">
      <Head>
        <title>Microsoft Product Pitch | Kahana</title>
        <meta
          name="description"
          content="A comprehensive pitch for Microsoft's next generation AI productivity platform"
        />
          ...
          <div className="max-w-6xl mx-auto relative">
            ...
            <div className="relative w-full flex justify-center items-center mt-8">
              <Image
                ...
                alt="Microsoft AI Productivity Interface"
                width={800}
                height={450}
