        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 bg-gradient-to-br from-kahana-accent-sky/20 to-kahana-secondary-300/10 rounded-2xl">
            <div className="flex items-center mb-6">
              ...
              <h3 className="text-2xl font-semibold text-[#4A5745]">Oasis Browser: True Zero Trust</h3>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-white rounded-xl p-6 shadow-sm">
                <h4 className="font-semibold text-[#4A5745] mb-2">Continuous Verification</h4>
                <p className="text-[#4A5745]">Real-time identity checks</p>
              </div>
              <div className="bg-white rounded-xl p-6 shadow-sm">
                <h4 className="font-semibold text-[#4A5745] mb-2">Granular Control</h4>
                <p className="text-[#4A5745]">Policy-based access</p>
              </div>
              <div className="bg-white rounded-xl p-6 shadow-sm">
                <h4 className="font-semibold text-[#4A5745] mb-2">Complete Visibility</h4>
                <p className="text-[#4A5745]">Comprehensive monitoring</p>
              </div>
            </div>
          </div>
        </div>
