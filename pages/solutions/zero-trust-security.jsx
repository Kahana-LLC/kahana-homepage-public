...
const conceptCards = [
  {
    ...
    description: "Continuous identity verification and contextual access control",
    details: [
      {
        title: "Identity Verification",
        explanation: "Real-time user identity validation",
        technical: "Multi-factor authentication and device posture checks"
      },
      {
        title: "Contextual Access",
        explanation: "Dynamic access based on risk context",
        technical: "Risk-based authentication and authorization"
      }
    ]
  },
  {
    title: "Security Controls",
    description: "Comprehensive security controls with granular policy enforcement",
    details: [
      {
        title: "Policy Enforcement",
        explanation: "Automated security policy management",
        technical: "Real-time policy verification and enforcement"
      },
      {
        title: "Activity Monitoring",
        explanation: "Continuous security monitoring",
        technical: "Real-time threat detection and response"
      }
    ]
  },
  {
    title: "Compliance & Audit",
    description: "Complete visibility and compliance management",
    details: [
      {
        title: "Audit Trails",
        explanation: "Comprehensive activity logging",
        technical: "Detailed audit logs and compliance reporting"
      },
      {
        title: "Compliance Management",
        explanation: "Automated compliance controls",
        technical: "Policy-based compliance enforcement"
      }
    ]
  }
];
...
export default function ZeroTrust() {
  return (
    <>
      <Head>
        <title>Zero Trust Security | Kahana</title>
        <meta
          name="description"
          content="Implement Zero Trust security with Oasis Browser. Enable continuous verification, least privilege access, and comprehensive security controls."
        />
      </Head>
      <Script
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-5xl font-bold text-gray-900 mb-6">
              Zero Trust Security,<br />Made Simple
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-gradient-to-br from-gray-50 to-indigo-50/30 rounded-2xl p-8 border border-gray-100">
              ...
              <ul className="space-y-2">
                <li className="flex items-center text-gray-600">
                  ...
                  <span>Perimeter-based security</span>
                </li>
                <li className="flex items-center text-gray-600">
                  <span className="text-red-500 mr-2">✗</span>
                  <span>Implicit trust</span>
                </li>
                <li className="flex items-center text-gray-600">
                  <span className="text-red-500 mr-2">✗</span>
            ...
            <div className="bg-gradient-to-br from-gray-50 to-purple-50/30 rounded-2xl p-8 border border-gray-100">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-2xl font-semibold text-gray-900">Modern Security Needs</h3>
              </div>
              <p className="text-gray-600 mb-4">
          ...
          <div className="mt-8 bg-gradient-to-r from-indigo-50 to-purple-50 rounded-2xl p-8 border border-indigo-100">
            <div className="flex items-center mb-6">
              ...
              <h3 className="text-2xl font-semibold text-gray-900">Oasis Browser: True Zero Trust</h3>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-white rounded-xl p-6 shadow-sm">
                <h4 className="font-semibold text-gray-900 mb-2">Continuous Verification</h4>
                <p className="text-gray-600">Real-time identity checks</p>
              </div>
              <div className="bg-white rounded-xl p-6 shadow-sm">
                <h4 className="font-semibold text-gray-900 mb-2">Granular Control</h4>
                <p className="text-gray-600">Policy-based access</p>
              </div>
              <div className="bg-white rounded-xl p-6 shadow-sm">
                <h4 className="font-semibold text-gray-900 mb-2">Complete Visibility</h4>
                <p className="text-gray-600">Comprehensive monitoring</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="bg-gradient-to-r from-kahana-primary to-indigo-700 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            Download Oasis Browser today and start your journey to true Zero Trust security.
          </p>
          <Link href="/download">
