        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-gradient-to-br from-kahana-accent-sky/20 to-kahana-secondary-300/10 rounded-2xl">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-2xl font-semibold text-[#4A5745]">Remote Work Era</h3>
              </div>
              <p className="text-[#4A5745] mb-4">
          ...
          <div className="mt-8 bg-gradient-to-br from-kahana-accent-sky/20 to-kahana-secondary-300/10 rounded-2xl">
            <div className="flex items-center mb-6">
              ...
              <h3 className="text-2xl font-semibold text-[#4A5745]">The Oasis Browser Bridges the Gap</h3>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-white rounded-xl p-6 shadow-sm">
                <h4 className="font-semibold text-[#4A5745] mb-2">Zero Trust Security</h4>
                <p className="text-[#4A5745]">Protection that follows your workers</p>
              </div>
              <div className="bg-white rounded-xl p-6 shadow-sm">
                <h4 className="font-semibold text-[#4A5745] mb-2">Full Flexibility</h4>
                <p className="text-[#4A5745]">Work from anywhere, securely</p>
              </div>
              <div className="bg-white rounded-xl p-6 shadow-sm">
                <h4 className="font-semibold text-[#4A5745] mb-2">Complete Control</h4>
                <p className="text-[#4A5745]">Visibility and control everywhere</p>
              </div>
            </div>
          </div>
        </div>
