      ...
      <div className="bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          {featuredWhitePapers.length > 0 && (
            <div className="mb-16">
              <h2 className="text-2xl font-bold text-[#011910] mb-8 text-center">
                Featured White Papers
              </h2>
            ...
            {regularWhitePapers.length > 0 ? (
              ...
              <div className="text-center py-12">
                <div className="max-w-md mx-auto">
                  ...
                  <h3 className="mt-2 text-lg font-medium text-[#011910]">No white papers found</h3>
            ...
            <div className="bg-[#21706c] rounded-lg p-8 text-white">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-md mx-auto">
                <input
                  ...
                  className="flex-1 px-4 py-2 rounded-md text-[#011910] placeholder-gray-500"
                />
