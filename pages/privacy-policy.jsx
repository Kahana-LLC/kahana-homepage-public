        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <article className="prose prose-lg max-w-none">
            ...
            <section id="personal-data-collect" className="mb-16 scroll-mt-8">
              ...
              <h2 className="text-3xl font-bold text-[#3B2F1A] mb-6">1. Personal Data Collection</h2>
              ...
              <h3 className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8">Information provided by you</h3>
              <ul className="list-disc list-inside text-gray-700 space-y-3 mb-6 ml-4">
                ...
                <li>Contact and feedback. When you reach out to us with feedback, suggestions, or inquiries (e.g., via <Link href="https://kahana.io/contact" className="text-[#8A6622] no-underline hover:no-underline font-semibold">our contact form</Link>), we may gather the information you provide, which includes your contact information and the content of your message.</li>
              </ul>

              <h3 className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8">Information collected when you use our Services</h3>
              <ul className="list-disc list-inside text-gray-700 space-y-3 mb-6 ml-4">
              ...
              <h3 className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8">Cookies and Similar Technologies</h3>
              ...
              <div className="space-y-4 mb-6">
                <div>
                  <h4 className="text-xl font-semibold text-[#3B2F1A] mb-2">Strictly Necessary</h4>
                ...
                <div>
                  <h4 className="text-xl font-semibold text-[#3B2F1A] mb-2">Analytics</h4>
                  <p className="text-gray-700 leading-relaxed mb-2">
              ...
              <p className="text-gray-700 leading-relaxed mb-6">
                ...
                <a href="https://mixpanel.com/legal/privacy-policy/" target="_blank" rel="noopener noreferrer" className="text-[#8A6622] no-underline hover:no-underline font-semibold">Mixpanel&apos;s Privacy Policy</a>.
              </p>

              <h3 className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8">Information collected from other sources</h3>
              <ul className="list-disc list-inside text-gray-700 space-y-3 mb-6 ml-4">
            ...
            <section id="how-we-use" className="mb-16 scroll-mt-8">
              ...
              <h2 className="text-3xl font-bold text-[#3B2F1A] mb-6">2. How We Use Your Personal Data</h2>
              ...
              <h3 id="email-communications" className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8 scroll-mt-8">Email communications</h3>
              <p className="text-gray-700 leading-relaxed mb-4">
              ...
              <p className="text-gray-700 leading-relaxed mb-6">
                ...
                <Link href="/terms-and-conditions#communications" className="text-[#8A6622] no-underline hover:no-underline font-semibold">Terms and Conditions</Link>.
              </p>
            </section>
            ...
            <section id="how-we-share" className="mb-16 scroll-mt-8">
              ...
              <h2 className="text-3xl font-bold text-[#3B2F1A] mb-6">3. How We Share Your Information</h2>
              ...
              <h3 className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8">With third-party service providers</h3>
              <p className="text-gray-700 leading-relaxed mb-4">
              ...
              <h3 className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8">With third-party integrations and AI partners</h3>
              <p className="text-gray-700 leading-relaxed mb-6">
              ...
              <h3 className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8">As required by law and similar disclosures</h3>
              <p className="text-gray-700 leading-relaxed mb-6">
              ...
              <h3 className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8">In business transfers</h3>
              <p className="text-gray-700 leading-relaxed mb-6">
              ...
              <h3 className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8">With your consent</h3>
              <p className="text-gray-700 leading-relaxed mb-6">
            ...
            <section id="data-storage-security" className="mb-16 scroll-mt-8">
              ...
              <h2 className="text-3xl font-bold text-[#3B2F1A] mb-6">4. Data Storage and Security</h2>
              
              <h3 className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8">Data Retention</h3>
              <p className="text-gray-700 leading-relaxed mb-4">
              ...
              <h3 className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8">Security Measures</h3>
              <p className="text-gray-700 leading-relaxed mb-4">
              ...
              <p className="text-gray-700 leading-relaxed mb-6">
                ...
                <Link href="/security" className="text-[#8A6622] no-underline hover:no-underline font-semibold">Security</Link> page.
              </p>
            </section>
            ...
            <section id="lawful-basis" className="mb-16 scroll-mt-8">
              ...
              <h2 className="text-3xl font-bold text-[#3B2F1A] mb-6">5. Legal Basis for Processing Personal Data</h2>
              ...
              <div className="space-y-4 mb-6">
                <div>
                  <h3 className="text-xl font-bold text-[#3B2F1A] mb-2">Contract</h3>
                ...
                <div>
                  <h3 className="text-xl font-bold text-[#3B2F1A] mb-2">Legitimate interests</h3>
                  <p className="text-gray-700 leading-relaxed">
                ...
                <div>
                  <h3 className="text-xl font-bold text-[#3B2F1A] mb-2">Legal obligations</h3>
                  <p className="text-gray-700 leading-relaxed">
                ...
                <div>
                  <h3 className="text-xl font-bold text-[#3B2F1A] mb-2">Consent</h3>
                  <p className="text-gray-700 leading-relaxed">
            ...
            <section id="your-choices-rights" className="mb-16 scroll-mt-8">
              ...
              <h2 className="text-3xl font-bold text-[#3B2F1A] mb-6">6. Your Privacy Rights and Choices</h2>
              ...
              <h3 className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8">Your Choices About Cookies and Tracking</h3>
              <p className="text-gray-700 leading-relaxed mb-4">
              ...
              <h3 className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8">California Residents' Rights</h3>
              <p className="text-gray-700 leading-relaxed mb-4">
              ...
              <div className="space-y-4 mb-6">
                ...
                <div>
                  <h3 className="text-xl font-bold text-[#3B2F1A] mb-2">Right to Rectification and Deletion</h3>
                  <p className="text-gray-700 leading-relaxed">
                ...
                <div>
                  <h3 className="text-xl font-bold text-[#3B2F1A] mb-2">Right to Restriction and Objection</h3>
                  <p className="text-gray-700 leading-relaxed">
                ...
                <div>
                  <h3 className="text-xl font-bold text-[#3B2F1A] mb-2">Right to Withdraw Consent</h3>
                  <p className="text-gray-700 leading-relaxed">
              ...
              <div className="space-y-4 mb-6">
                <div>
                  <h3 className="text-xl font-bold text-[#3B2F1A] mb-2">Email preferences</h3>
                  <p className="text-gray-700 leading-relaxed">
                ...
                <div>
                  <h3 className="text-xl font-bold text-[#3B2F1A] mb-2">Managing Your Account</h3>
                  <p className="text-gray-700 leading-relaxed">
                    ...
                    <Link href="/support" className="text-[#8A6622] no-underline hover:no-underline font-semibold">Delete my account</Link>{' '}
                    page, or <Link href="https://kahana.io/contact" className="text-[#8A6622] no-underline hover:no-underline font-semibold">contact us through our contact form</Link>.
                  </p>
                </div>
                <div>
                  <h3 className="text-xl font-bold text-[#3B2F1A] mb-2">Do Not Track Signals</h3>
                  <p className="text-gray-700 leading-relaxed">
            ...
            <section id="third-party-services" className="mb-16 scroll-mt-8">
              ...
              <h2 className="text-3xl font-bold text-[#3B2F1A] mb-6">7. Third-Party Services</h2>
              ...
              <p className="text-gray-700 leading-relaxed mb-6">
                ...
                <a href="https://tally.so/privacy" target="_blank" rel="noopener noreferrer" className="text-[#8A6622] no-underline hover:no-underline font-semibold">Tally&apos;s privacy policy</a>.
              </p>
            </section>
            ...
            <section id="international-transfers" className="mb-16 scroll-mt-8">
              ...
              <h2 className="text-3xl font-bold text-[#3B2F1A] mb-6">8. International Data Transfers</h2>
            ...
            <section id="children-privacy" className="mb-16 scroll-mt-8">
              ...
              <h2 className="text-3xl font-bold text-[#3B2F1A] mb-6">9. Privacy for Children</h2>
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                If you are a parent or guardian and believe that your child under the age of 13 has provided us with Personal Data without your consent, please <Link href="https://kahana.io/contact" className="text-[#8A6622] no-underline hover:no-underline font-semibold">contact us</Link> so that we can address your concerns.
              </p>
              <p className="text-gray-700 leading-relaxed mb-6">
            ...
            <section id="changes-policy" className="mb-16 scroll-mt-8">
              ...
              <h2 className="text-3xl font-bold text-[#3B2F1A] mb-6">10. Changes to This Privacy Policy</h2>
              ...
              <h3 className="text-2xl font-bold text-[#3B2F1A] mb-4 mt-8">Recent Updates</h3>
              <div className="bg-[#EDE6D2] border-l-4 border-oasis-green-600 p-4 mb-6">
                <p className="text-sm font-semibold text-[#3B2F1A] mb-2">July 16, 2026</p>
              ...
              <div className="bg-[#EDE6D2] border-l-4 border-oasis-green-600 p-4 mb-6">
                <p className="text-sm font-semibold text-[#3B2F1A] mb-2">July 14, 2026</p>
                <ul className="list-disc list-inside text-gray-700 space-y-2 text-sm ml-4">
            ...
            <section id="contact-us" className="mb-16 scroll-mt-8">
              ...
              <h2 className="text-3xl font-bold text-[#3B2F1A] mb-6">11. Contact Us</h2>
              ...
              <div className="text-gray-700 leading-relaxed mb-6">
                <p className="mb-4">
                  <strong>Contact:</strong> <Link href="https://kahana.io/contact" className="text-[#8A6622] no-underline hover:no-underline font-semibold">our contact form</Link>
                </p>
                <p className="mb-4">
