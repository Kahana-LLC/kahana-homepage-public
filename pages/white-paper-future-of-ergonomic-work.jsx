    ...
    <>
      ...
      <main className="min-h-screen bg-gradient-to-b from-gray-50 to-white pt-24 pb-16 lg:ml-64">
        <div className="max-w-none mx-auto px-4 sm:px-6 lg:px-12 xl:px-16">
          ...
          <div className="bg-gradient-to-r from-[#66C2BE] to-[#4A9E9A] rounded-2xl p-8 mb-16">
            <div className="text-center">
              ...
              <a 
                ...
                className="inline-flex items-center bg-white text-[#66C2BE] font-bold px-8 py-4 rounded-lg hover:bg-gray-50 transition-colors duration-300 shadow-lg"
              >
                <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg>
