      ...
      <main className="min-h-screen bg-gradient-to-b from-gray-50 to-white pt-24 pb-16 lg:ml-64">
        <div className="max-w-none mx-auto px-4 sm:px-6 lg:px-12 xl:px-16">
          ...
          <div className="mb-16">
            ...
            <button 
              id="sidebar-toggle"
              className="fixed top-1/2 left-4 -translate-y-1/2 z-[9999] lg:hidden bg-white/95 backdrop-blur-sm border border-gray-200 rounded-lg p-3 shadow-lg hover:bg-gray-50 transition-colors duration-300"
              onClick={() => {
