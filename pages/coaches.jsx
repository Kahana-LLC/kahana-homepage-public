...
const CoachesPage = () => {
  return (
    <>
      <Head>
        <title>Coaches | Kahana</title>
        <meta
          name="description"
          content="Transform your coaching knowledge into new revenue streams with Kahana's enterprise browsing platform."
        />
      </Head>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <Link href="/affiliates">
              <button className="px-6 py-2 bg-[#3B675E] text-white rounded-md shadow-md hover:bg-[#024324] transition-colors">
                Learn more
              </button>
            </Link>
          </div>
