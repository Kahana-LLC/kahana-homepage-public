...
const staticSitemapSections = [
  {
    ...
    links: [
      ...
      { text: 'Aura pathways', href: '/features/aura-pathways' },
      { text: 'Aura, trust, and information quality', href: '/features/aura-and-trust' },
      { text: 'Use cases', href: '/use-cases' },
      { text: 'Who it is for', href: '/for' },
      { text: 'Creator stories', href: '/success-stories' },
      { text: 'Your stack', href: '/compare' },
      { text: 'For creators', href: '/creators' },
      { text: 'For learners', href: '/learners' },
      { text: 'Climate commitment', href: '/climate-commitment' },
      { text: 'Ad-free commitment', href: '/ad-free-commitment' },
      { text: 'iOS and Android waitlist', href: '/app-waitlist' },
      ...
      { text: 'Suggestion engine', href: '/suggestion-engine' },
      { text: 'What to post', href: '/do-well' },
      { text: 'Partnerships', href: 'https://kahana.io/contact?source=partnerships' },
      { text: 'Integrations', href: 'https://kahana.io/contact?source=integrations' },
      { text: 'Be a podcast guest', href: '/podcast-guest' },
      { text: 'Become an affiliate', href: '/affiliates' },
      { text: 'Discussions and forums', href: '/features/discussions' },
