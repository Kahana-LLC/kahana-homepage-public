...
export default function OasisOpenBetaPressRelease() {
  return (
    <>
      <SEO
        title="Aura Library completes Oasis closed beta; privacy-first browser opens next chapter (St. Louis)"
        description="Aura Library announces Oasis browser closed beta complete: a refuge-focused, privacy-first web experience with AI in the core, plus Product Hunt on May 27, 2026 for waitlist supporters. Based in St. Louis."
        url={CANONICAL}
        type="article"
      />
        ...
        <header className="border-b border-oasis-green-100 bg-oasis-green-50/40">
          <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6 lg:px-8">
            ...
            <h1 className="mt-6 text-3xl font-bold tracking-tight text-oasis-green-950 sm:text-4xl">
              Aura Library completes Oasis closed beta; opens next chapter for a privacy-first browser with AI in the core
            </h1>
            <p className="mt-4 text-lg italic text-oasis-green-800 sm:text-xl">
              ...
              behavior that happens quietly in the background. Aura Library built{' '}
              ...
              with waitlist users and teams, Aura Library is moving toward open beta and will spotlight the launch on{' '}
        ...
        <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
          <div className="border-t border-oasis-green-200 pt-8">
            ...
            <div className="mt-6 space-y-6 text-base leading-relaxed text-oasis-green-900">
              <p>
                <strong>Aura Library</strong> today announced that <strong>Oasis</strong>, its privacy-first web browser with AI
              ...
              <p>
                ...
                quo with ad-blocking controls, privacy-first defaults, and a clear posture that Aura Library does not sell users&apos;
                browsing data, collecting only what people explicitly permit, in line with the promises surfaced on Aura Library&apos;s
              ...
              <p>
                ...
                product overview for how Aura Library positions the full consumer experience.
              </p>

              <h2 className="mt-12 text-2xl font-bold text-oasis-green-950">Why &quot;Oasis&quot;: a refuge, not another noisy tab</h2>
              <p>
                Aura Library&apos;s mission language is deliberate: an oasis is a refuge, shelter and calm in a harsh landscape. The
              ...
              <p>
                That framing mirrors what visitors see in Aura Library&apos;s public story:{' '}
                <strong>Your Online Refuge. Your Terms.</strong> In practice, Aura Library describes Oasis as a sanctuary where
              ...
              <blockquote className="border-l-4 border-oasis-green-600/35 bg-oasis-green-50/60 py-5 pl-5 pr-4 text-oasis-green-800 italic">
                ...
                <p className="mt-3 text-sm not-italic text-oasis-green-700">
                  <strong>Adam Kershner</strong>, CEO and Founder, Aura Library
                </p>
              </blockquote>
              <p>
                Kershner built his career inside IT teams at a large enterprise, where he saw how quickly security gaps compound
                when everyday tools are not designed with security in mind. That experience shaped Aura Library&apos;s product choices:
              ...
              <p>
                ...
                covers how Aura Library respects platform limits on switching. For sensitive moments when the browser acts on your
                behalf, see{' '}
                <Link href="/help" className={linkClass}>
              ...
              <p>
                ...
                hub, which links to every browser and enterprise deep dive Aura Library publishes for reviewers and technical readers.
              </p>

              <h2 className="mt-12 text-2xl font-bold text-oasis-green-950">Teach Oasis to fit your workflows (Amplifier)</h2>
              <p>
                Even strong models miss tone, speed, and risk in real tabs. Aura Library is developing{' '}
                <Link href="/help" className={linkClass}>
                  Oasis Amplifier
                </Link>{' '}
              ...
              <p>
                Aura Library kept the beta intentionally limited so it could listen closely, iterate quickly, and validate reliability
              ...
              <p>
                ...
                see. Aura Library contributes to industry-wide learning through the{' '}
              ...
              <p>
                For security and IT teams, Aura Library extends that philosophy into{' '}
              ...
              <p>
                Aura Library will spotlight Oasis on{' '}
                <a href="https://www.producthunt.com/" rel="noopener noreferrer" target="_blank" className={linkClass}>
                  Product Hunt
                </a>{' '}
              ...
              <h2 className="mt-12 text-2xl font-bold text-oasis-green-950">About Aura Library</h2>
              <p>
                Aura Library builds Oasis for individuals who want a calmer, more private web, and for organizations that need secure
