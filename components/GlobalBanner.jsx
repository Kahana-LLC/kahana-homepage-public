      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between py-3">
            ...
            <div className="ml-3">
              <p className="text-sm font-medium text-white">
                ...
                <span className="hidden md:inline">
                  Meet Oasis: The first AI browser designed to meld with the way your mind works naturally. Built for ergonomic work, focus, and spatial ease. Join our <a href="https://discord.gg/erkguEsVHa" target="_blank" rel="noopener noreferrer" className="!text-white underline hover:!text-white/80 transition-colors" style={{color: 'white'}}>Discord community</a> to stay updated!
                </span>
              </p>
            </div>
          </div>
          <div className="flex items-center space-x-3">
            ...
            <a href="https://discord.gg/erkguEsVHa" target="_blank" rel="noopener noreferrer">
