      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between py-3 gap-4 md:gap-6">
          ...
          <div className="flex items-center space-x-3">
            ...
            <Link
              href="/community"
              className="nav-button download hidden md:inline-flex items-center justify-center rounded-md text-white font-bold shadow-sm px-4 py-3 text-base no-underline hover:no-underline focus:no-underline space-x-2"
              style={{ textDecoration: 'none', backgroundColor: '#788B59' }}
            >
            ...
            <button
              ...
              className="nav-button download inline-flex items-center justify-center rounded-md text-white font-bold shadow-sm px-3 py-3 text-base no-underline hover:no-underline focus:no-underline"
              style={{ textDecoration: 'none', backgroundColor: '#788B59' }}
            >
