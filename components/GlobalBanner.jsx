      ...
      <div className="banner-container">
        <div className="flex items-center justify-between py-3 gap-4 md:gap-8">
          ...
          <div className="flex items-center gap-2">
            <Link
              href="/community"
              className="btn-primary hidden md:inline-flex items-center justify-center px-4 py-2.5 text-sm no-underline hover:no-underline focus:no-underline gap-2 whitespace-nowrap"
            >
