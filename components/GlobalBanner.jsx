      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between py-3 gap-4 md:gap-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link
              href="/community"
              className="nav-button download hidden md:inline-flex items-center justify-center rounded-md text-white font-bold shadow-sm px-4 py-2.5 text-sm no-underline hover:no-underline focus:no-underline gap-2 whitespace-nowrap"
              style={{ textDecoration: 'none', backgroundColor: '#788B59' }}
            >
            ...
            <button
              ...
              className="nav-button download inline-flex items-center justify-center rounded-md text-white font-bold shadow-sm px-2.5 py-2.5 text-sm no-underline hover:no-underline focus:no-underline min-w-[2.5rem]"
              style={{ textDecoration: 'none', backgroundColor: '#788B59' }}
