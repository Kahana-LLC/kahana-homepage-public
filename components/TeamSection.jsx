...
export default function TeamSection() {
  return (
    <>
      <Head>
        <title>Aura Library - Company</title>
        <meta name="description" content="Meet the Aura Library team, the hungry avengers driving our mission forward." />
        <meta property="og:title" content="Aura Library HQ Team" />
        <meta property="og:description" content="Meet the Aura Library team, the hungry avengers driving our mission forward." />
        <meta property="og:image" content="/path/to/og-image.jpg" />
        <meta property="og:url" content="https://kahana.io/team" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Aura Library HQ Team" />
        <meta name="twitter:description" content="Meet the Aura Library team, the hungry avengers driving our mission forward." />
        ...
        <div className="mx-auto grid max-w-7xl gap-x-8 gap-y-20 px-6 lg:px-8 xl:grid-cols-3">
          <div className="max-w-2xl">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              The team of hungry avengers behind Aura Library.
            </p>
          </div>
