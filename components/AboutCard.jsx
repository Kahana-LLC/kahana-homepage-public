                    ...
                    <blockquote className="mt-8">
                      <div className="relative text-lg font-medium text-white md:flex-grow">
                        ...
                        <p className="relative">
                          We&apos;re creating a thriving ecosystem where people can access the highest-quality knowledge on earth, curated by everyone from solopreneurs to S&amp;P 500 companies.
                        </p>
                      </div>
