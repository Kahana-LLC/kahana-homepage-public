                  ...
                  <div>
                    ...
                    <div className="mt-8 flex flex-col items-center space-y-4 md:flex-row md:space-x-4 md:space-y-0">
                      <a
                        ...
                        className="rounded-md border border-transparent bg-black py-3 px-8 text-lg font-medium text-white shadow-sm hover:bg-[#024324] focus:outline-none focus:ring-2 focus:ring-[#024324] focus:ring-offset-2 text-center"
                      >
                        Start earning 
                      </a>
                      <a
