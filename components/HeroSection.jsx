                    ...
                    <div className="mt-2">
                        ...
                        <div className="flex justify-center items-center space-x-6">
                          <a
                            ...
                            className="flex-1 rounded-md border border-transparent bg-[#038270] py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-[#024324] focus:outline-none focus:ring-2 focus:ring-[#024324] focus:ring-offset-2"
                          >
                            Sign up for free
                          </a>
