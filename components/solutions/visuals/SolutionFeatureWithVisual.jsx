    ...
    >
      <div className="grid grid-cols-1 gap-5 lg:grid-cols-2 lg:items-start">
        <div className={isEven ? 'order-1' : 'order-1 lg:order-2'}>
          <h3 className="text-base md:text-lg font-semibold text-oasis-green-800 leading-snug tracking-tight mb-3">
            {feature.title}
          </h3>
          ...
          <ul className="space-y-2.5">
            {feature.details.map((detail) => (
              <li key={detail} className="flex gap-3 text-sm text-oasis-green-800/95 leading-relaxed">
