                ...
                <div className="relative h-[calc(100%-2rem)] sm:h-[calc(100%-3rem)] bg-gradient-to-br from-kahana-accent-sky/20 via-kahana-secondary-300/10 to-kahana-accent-sky/30">
                  ...
                  <div className="relative flex-1 p-2 sm:p-4">
                    <div className="text-center mb-4 sm:mb-6 flex items-center justify-center space-x-1.5 sm:space-x-2">
                      <svg className="w-2.5 h-2.5 sm:w-3 sm:h-3 text-[#66C2BE]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                      </svg>
                      <span className="text-[10px] sm:text-xs font-light tracking-wide bg-gradient-to-r from-[#66C2BE] to-[#8CB7D0] bg-clip-text text-transparent">Unicorn Inc.</span>
                    </div>
                    {/* Shortcuts Grid */}
                    <div className="grid grid-cols-3 sm:grid-cols-5 gap-x-8 gap-y-4 sm:gap-4 max-w-[280px] sm:max-w-lg mx-auto px-4 sm:px-0">
                      {[
                        ...
                        {
                          icon: <svg className="w-6 h-6 text-[#66C2BE]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>,
                          label: "Calendar",
                          showOnMobile: false
                        },
                        {
                          icon: <svg className="w-6 h-6 text-[#66C2BE]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z" /></svg>,
                          label: "Drive",
                          showOnMobile: false
                        },
                        {
                        ...
                        >
                          ...
                          <span className="mt-2 text-[10px] sm:text-xs text-gray-600 w-full text-center truncate px-1">{shortcut.label}</span>
                        </div>
                      ))}
                    </div>
                  </div>
                  ...
                  <div className="absolute bottom-4 right-4 flex items-end">
                    ...
                    {isChatOpen && (
                      <div className="hidden lg:flex flex-col mr-3 w-80 h-72 bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                        <div className="flex items-center justify-between p-4 border-b border-gray-100 bg-gradient-to-r from-[#66C2BE]/5 to-[#8CB7D0]/5">
                          <div className="flex items-center space-x-3">
                            <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-[#66C2BE] to-[#8CB7D0] flex items-center justify-center">
                        ...
                        <div className="flex-1 p-4 bg-gradient-to-br from-[#E3DFF1]/5 via-[#8CB7D0]/5 to-[#E3DFF1]/5">
                          <div className="flex items-start space-x-3 mb-4">
                            <div className="w-6 h-6 rounded-lg bg-[#66C2BE]/10 flex-shrink-0 flex items-center justify-center">
                              <svg className="w-4 h-4 text-[#66C2BE]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                              </svg>
                            </div>
                            <div className="bg-white rounded-2xl rounded-tl-none p-3 shadow-sm">
                              <p className="text-sm text-gray-600">
                                {showDemoMessage && (
                                  <>Unfortunately, this little chat bot on our landing page isn't integrated with AI. To see the real thing, <Link href="/schedule-demo" className="text-[#66C2BE] hover:underline">schedule a demo</Link>! 😉</>
                                )}
                              </p>
                            </div>
                          </div>
                        ...
                        <div className="p-4 bg-white border-t border-gray-100">
                          <form onSubmit={handleSendMessage} className="flex space-x-2">
                            <input
                              ...
                              className="flex-1 px-4 py-2 text-sm border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#66C2BE]/20 focus:border-[#66C2BE]"
                            />
                            <button 
                              type="submit"
