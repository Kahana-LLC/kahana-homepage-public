...
const features = [
  {
    ...
    description:
      'Build dynamic hubs of all your best knowledge (insights, frameworks, methodologies, best practices, etc.). It\'s like charging for access to your brain.',
    image: revenue,
  ...
  },
  {
    ...
    description:
      'Invite fellow experts to contribute and build hubs together.',
    image: collaboration,
      ...
      <Container>
        <div className="max-w-2xl md:mx-auto md:text-center xl:max-w-none text-center">
          <h2 className="text-3xl font-bold mb-4 md:px-12 lg:px-24">
            Manage your recurring revenue streams, collaborate with other experts, and gather customer feedback, all in one place.
          </h2>
        </div>
