    ...
    <div className="space-y-8">
      ...
      <div className="space-y-6">
        ...
        <p className="text-xl text-gray-600">
          Apple Intelligence is not just about making everyday tasks easier—it fundamentally elevates what users can accomplish with their devices. By deeply integrating advanced AI, Apple devices become true productivity engines, empowering people to get real work done, create, learn, and solve complex problems in ways never before possible.
        </p>
      </div>
          ...
          <div className="mt-4 space-y-4">
            ...
            <div className="p-4 bg-gray-50 rounded-lg">
              ...
              <ul className="list-disc list-inside mt-2 space-y-1 text-gray-600">
                ...
                <li>Transforms Apple devices into true productivity powerhouses</li>
            ...
            <div className="p-4 bg-gray-50 rounded-lg">
              ...
              <p className="text-gray-600">
                Apple Intelligence is not just about making everyday tasks easier—it's about unlocking the full potential of every Apple device, enabling users to achieve more than ever before.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="mt-4 space-y-4">
            ...
            <div className="p-4 bg-gray-50 rounded-lg">
              ...
              <p className="text-gray-600">
                When aggregated data is needed for improving services, Apple's differential privacy 
            ...
            <div className="p-4 bg-gray-50 rounded-lg">
              ...
              <p className="text-gray-600">
                Sensitive data and AI models are protected by Apple's Secure Enclave, providing 
