    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-4 bg-gray-50 rounded-lg">
            <h4 className="font-semibold text-black">Success Criteria</h4>
            <p className="text-gray-600 text-sm">
              As a user, I should be able to see the Siri AI assistant in Safari, access it, and enter commands through text, keyboard, voice, and gestures depending on device.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="mt-12 bg-black text-white p-8 rounded-2xl">
        ...
        <p className="text-gray-300 mt-6">
          As these parallel workstreams progress, the complete Apple ecosystem becomes increasingly touch-free, voice-first, and AI-enabled—empowering users to access, retrieve, and act on information instantly, wherever they are: at home or on the run.
        </p>
      </div>
    </div>
  );
