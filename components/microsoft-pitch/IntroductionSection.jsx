        ...
        <div className="max-w-6xl mx-auto relative">
          ...
          <div className="relative z-10 max-w-2xl">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-[56px] font-bold mb-6 text-white leading-tight tracking-tight">
              The Hephaestus Project: Transforming Microsoft's Productivity Universe with AI
            </h1>
            <p className="text-2xl text-gray-300 mb-12">
              How Microsoft can revolutionize productivity and collaboration by making AI the core of every user experience.
            </p>
          </div>
          {/* Centered image */}
