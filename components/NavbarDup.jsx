          ...
          <div className="flex items-center justify-between border-b py-2 px-10">
                ...
                <div className="MOBILE-MENU-CONTENT flex flex-col items-start justify-start h-full p-8">
                  <ul className="MENU-LINK-MOBILE-OPEN space-y-4 text-lg">
                    ...
                    <li key="Solutions" className="relative group">
                      <span className="text-gray-600 hover:text-gray-800 cursor-pointer" onMouseEnter={toggleSolutionsDropdown} onMouseLeave={toggleSolutionsDropdown}>
                        Solutions
                      </span>
            ...
            <ul className="DESKTOP-MENU hidden space-x-8 lg:flex ml-4">
              <li key="Solutions" className="relative group" onMouseEnter={toggleSolutionsDropdown} onMouseLeave={toggleSolutionsDropdown}>
                <span className="text-base font-small text-gray-600 cursor-pointer">
                  Solutions
                </span>
                <ul className={`absolute left-0 w-auto bg-white border border-gray-300 ${isSolutionsDropdownOpen ? 'block' : 'hidden'}`} style={{ zIndex: 999 }}>
                  {solutionsDropdown.map((link) => (
                    <li key={link.name}>
                      <Link href={link.href} className="block px-4 py-3 text-gray-600 hover:text-gray-800">
                        {link.name}
