  ...
  return (
    <div className="space-y-8">
      ...
      <p className="text-xl text-gray-600">
        In an era where technology is reshaping every aspect of our lives, Mozilla continues to lead the charge in innovation. 
        Our latest product represents a quantum leap forward, combining cutting-edge technology with Mozilla's signature design 
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
        <div className="space-y-4">
          ...
          <p className="text-gray-600">
            ...
            while maintaining the simplicity and elegance that Mozilla is known for.
          </p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <p className="text-gray-600">
            To push the boundaries of what's possible, creating products that not only meet but exceed our users' 
