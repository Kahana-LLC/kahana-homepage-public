...
const WhyMozillaSection = () => {
  return (
    <div className="space-y-8">
      <div className="space-y-6">
        <h3 className="text-2xl font-semibold text-gray-800">Our Unique Position</h3>
        <p className="text-gray-600">
          Mozilla's position in the market is unparalleled, combining decades of innovation with a proven track record 
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
        <div className="space-y-4">
          ...
          <p className="text-gray-600">
            Mozilla's design philosophy combines form and function, creating products that are not only beautiful 
        ...
        <div className="space-y-4">
          ...
          <p className="text-gray-600">
            The Mozilla ecosystem provides seamless integration across devices, creating a unified experience that 
...
export default WhyMozillaSection; 