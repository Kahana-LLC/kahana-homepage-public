...
export default function TechnicalInteractionDataDoc() {
  ...
  return (
    <div className="doc-content technical-interaction-data-doc max-w-none px-0 py-0">
      ...
      <aside className="my-8 rounded-r-lg border-l-4 border-[#8BA500] bg-[#F3F8E4] p-6">
        <strong className="mb-2 block text-[#30400D]">What sets Oasis apart</strong>
      ...
      <section className="my-12">
        ...
        <ol className="list-decimal space-y-2 pl-5 text-[#30400D]/85">
