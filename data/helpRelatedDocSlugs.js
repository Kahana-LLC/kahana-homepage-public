...
export const HELP_RELATED_DOC_SLUGS = {
  ...
  clubs: ['club-feed-and-events', 'explore', 'messages-and-privacy'],
  'club-feed-and-events': ['clubs', 'notifications', 'messages-and-privacy'],
  notes: ['adding-files-and-embeds', 'hubs', 'saving-and-collections'],
  following: ['profiles', 'for-you-and-taste', 'saving-and-collections'],
  'cognition-streak': ['learning-analytics', 'how-aura-works', 'notifications'],
  'learning-analytics': ['cognition-streak', 'creator-analytics', 'explore'],
  ...
  'creator-analytics': ['list-hub-on-explore', 'learning-analytics', 'earning'],
