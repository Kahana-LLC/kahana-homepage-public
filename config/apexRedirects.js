...
function pathPreservePrefixes(origins) {
  return [
    ...
    { prefix: '/collaborate', origin: origins.about },
    { prefix: '/podcast-guest', origin: origins.about },
    { prefix: '/tell-your-story', origin: origins.about },
    { prefix: '/story-gallery', origin: origins.about },
...
export function resolveApexRedirect(pathname, host = 'kahana.io') {
  ...
  // Oasis /features leftovers → about home. Kahana /features lives on about.
